...
chartevents = pd.read_pickle(data_path + 'prep/combined_chr.p')
procedures = pd.read_pickle(data_path + 'prep/combined_pcd.p')
inputevents = pd.read_pickle(data_path + 'prep/combined_ipt.p')
...
df_pretrain = examples[['ICUSTAY_ID']]
df_pretrain.loc[:, 'pretrain_label'] = 1
df_pretrain.to_csv(data_path + 'labels/Pretrain.csv', index=False)
