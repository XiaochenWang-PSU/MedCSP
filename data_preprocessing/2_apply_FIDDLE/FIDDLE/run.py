...
def main():
    ...
    print(args.population_fname)
    print(pd.read_csv(args.population_fname))
    ...
    df_data = pd.read_csv(output_dir + 'pre-filtered.csv')
    ...
    df_time_series = pd.read_csv("time_series_X_raw.csv")
